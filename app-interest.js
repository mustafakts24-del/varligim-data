...
function renderCreditBankList() {
  ...
  listEl.querySelectorAll('[data-credit-idx]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      // DÜZELTME (2026-09, katılım bankası etiketi): app-varliklar.js'teki
      // calcLoanBtn işleyicisi bu değişkeni okuyup "faiz" yerine "kâr payı"
      // göstermeyi kararlaştırıyor (bkz. app-varliklar.js).
      loanFormBankName = offer.bankName;
